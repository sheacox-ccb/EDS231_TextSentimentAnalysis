...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# tweet\_cleaner \textless{}{-} function(x)}
\CommentTok{\#   \{gsub("http[[:alnum:]]*",\textquotesingle{}\textquotesingle{}, x)}
\CommentTok{\#   gsub(\textquotesingle{}http\textbackslash{}\textbackslash{}S+\textbackslash{}\textbackslash{}s*\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove URLs}
\CommentTok{\#   gsub(\textquotesingle{}\textbackslash{}\textbackslash{}b+RT\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove RT}
\CommentTok{\#   gsub(\textquotesingle{}\#\textbackslash{}\textbackslash{}S+\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove Hashtags}
\CommentTok{\#   gsub(\textquotesingle{}@\textbackslash{}\textbackslash{}S+\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove Mentions}
\CommentTok{\#   gsub(\textquotesingle{}[[:cntrl:]]\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove Controls and special characters}
\CommentTok{\#   gsub("\textbackslash{}\textbackslash{}d", \textquotesingle{}\textquotesingle{}, x) \#\# Remove Controls and special characters}
\CommentTok{\#   gsub(\textquotesingle{}[[:punct:]]\textquotesingle{}, \textquotesingle{}\textquotesingle{}, x) \#\# Remove Punctuations}
\CommentTok{\#   gsub("\^{}[[:space:]]*","",x) \#\# Remove leading whitespaces}
\CommentTok{\#   gsub("[[:space:]]*$","",x) \#\# Remove trailing whitespaces}
\CommentTok{\#   gsub(\textquotesingle{} +\textquotesingle{},\textquotesingle{} \textquotesingle{},x) \#\# Remove extra whitespaces}
\CommentTok{\# \}}

\NormalTok{tweets\_clean }\OtherTok{\textless{}{-}}\NormalTok{ tweets }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{text\_clean =}\NormalTok{ text)  }\CommentTok{\# keeping a column of the original text as a check}

\NormalTok{tweets\_clean}\SpecialCharTok{$}\NormalTok{text\_clean }\OtherTok{\textless{}{-}} \FunctionTok{gsub}\NormalTok{(}\StringTok{"@[\^{}[:space:]]*"}\NormalTok{, }\StringTok{""}\NormalTok{, tweets\_clean}\SpecialCharTok{$}\NormalTok{text\_clean) }
...
\NormalTok{all\_emojis\_in\_tweets }\OtherTok{\textless{}{-}}\NormalTok{ emojis }\SpecialCharTok{\%\textgreater{}\%} 
...
\includegraphics{HW04_SentimentAnalysisII_files/figure-latex/unnamed-chunk-6-1.pdf}
