...
# remove the word grilled. Searching for coal ash resulted in a number of recipes. 
clean_tokens <- str_remove_all(string = clean_tokens, 
                               pattern = "grilled")
...
# remove the token "recipe". Searching for coal ash resulted in a number of recipes. 
clean_tokens <- str_remove_all(string = clean_tokens, 
                               pattern = "recipe")
...
# remove the tokens "grilled, grilling, grill". Searching for coal ash resulted in a number of recipes. 
clean_tokens <- str_remove_all(string = clean_tokens, 
                               pattern = "grilled")
